...
<section class="max-w-5xl pt-6 px-6 mx-auto bg-indigo-600 rounded-md shadow-md dark:bg-gray-800 mt-4">
    ...
    <form>
            ...
            <div>
                <label class="text-white dark:text-gray-200" for="passwordConfirmation">Members</label>
            ...
            <div>
                <label class="text-white dark:text-gray-200" for="passwordConfirmation">Abstract</label>
                <textarea id="textarea" type="textarea" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring"></textarea>
            </div>
