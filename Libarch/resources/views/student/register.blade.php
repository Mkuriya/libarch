...
<div class="content ">
        <div class="grid grid-cols-12 gap-4 pt-4 mb-2">
            <div class="col-span-9 pl-10 ">
                <a href="/admin/dashboard/student"><button class=" bg-gray-800 px-5 py-1 text-white dark:hover:text-indigo-500">Back</button></a>
            </div>
...
<div class="">
        <form action="/admin/dashboard/studentregister" method="POST" enctype="multipart/form-data" >
            ...
            <br>
                ...
                <input name="firstname" type="fisrtname" >
        <br>
                <label for="middlename">Middle Name</label>
                <input name="middlename" type="middlename" >
          <br>
