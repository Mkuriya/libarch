    ...
    <div class="relative mt-12 w-full max-w-lg sm:mt-10">
        <div id="login-container" class="holder mx-5 border dark:border-b-white/50 dark:border-t-white/50 border-b-white/20 sm:border-t-white/20 shadow-[20px_0_20px_20px]
            ...
            <div class="grid grid-cols-2 gap-4 buttons-group">
                <a href="/student/login" class="no-underline text-black student-button">
                    <div class="text-center bg-gray-200 rounded-full text-l mx-3 py-2 hover:bg-gray-700 hover:text-white">Student</div>
                </a>
                <a href="/admin/login" class="no-underline text-white admin-button">
                    <div class="text-center bg-whitebg rounded-full text-l mx-3 py-2 hover:bg-gray-700 hover:text-white">Admin</div>
                </a>
            </div>
