        ...
        <form action="/admin/register" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-5 gap-6 mt-4 sm:grid-cols-12">
                <div class="sm:col-span-10 col-span-10">
                    ...
                    <input name="email" value="{{ old('email') }}" id="password" type="email" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-white dark:focus:border-white ">
            ...
            <div class="flex justify-end mt-6">
                <button type="submit" class="w-1/2 sm:w-20  px-6 py-2 leading-5 text-white transition-colors 
                duration-200 transform bg-whitebg rounded-md hover:bg-gray-700
                focus:outline-none focus:bg-gray-600">Save</button>
                
                <a href="/admin/dashboard/admin"class="sm:w-20 ml-4 w-1/2 px-6 py-2 leading-5 text-white transition-colors 
                duration-200 transform bg-whitebg rounded-md hover:bg-gray-700
                focus:outline-none focus:bg-gray-600 text-center"><button type="button" >Back</button></a>
