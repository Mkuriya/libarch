...
<section class="max-w-screen-xl p-6 mx-auto bg-indigo-600 rounded-md shadow-md dark:bg-gray-800 ">
    ...
    <form action="/admin/dashboard/admin/edit/{{$admin->id}}" method="POST">
        ...
        <div class="grid grid-cols-4 gap-6 mt-4 sm:grid-cols-12">
            ...
            <div class=" col-span-2">
              ...
              <div>
                <input type="file" disabled name="photo" id="file" class="sr-only mt-1 flex justify-center px-4 pt-3 pb-4 border-2 border-gray-300 border-dashed rounded-md" />
    ...
    <div class="pl-10 flex justify-end ">
        <a href="/admin/dashboard/admin"><button class="relative bottom-9  w-20 px-2 py-2 leading-5 text-white transition-colors 
            duration-200 transform bg-whitebg rounded-md hover:bg-gray-700
