...
<div class="sm:mt-6 mt-0">
    <section class="max-w-screen-xl p-6 mx-auto rounded-md shadow-md bg-gray-800 sm:mt-5">
        <h1 class="text-xl font-bold text-white capitalize ">Student Information</h1>
        <hr>
        <div class="grid grid-cols-3 gap-6 mt-4 sm:grid-cols-12">   
            <div class="sm:col-span-5 col-span-12">
                ...
                <input value="{{$student->lastname}}" disabled name="lastname" id="lastname" type="text" class="block w-full px-4 py-2 mt-2 border rounded-md bg-gray-800 text-gray-300 border-gray-600 focus:border-white  ">
            </div>
            <div class="sm:col-span-5 col-span-12">
                <label class="text-gray-200 pl-2" for="firstname">First Name</label>
                <input value="{{$student->firstname}}"disabled name="firstname" id="firstname" type="text" class="block w-full px-4 py-2 mt-2 border rounded-md bg-gray-800 text-gray-300 border-gray-600 focus:border-white  ">
            </div>
            <div class="sm:col-span-2 col-span-12">
                <label class="text-gray-200" for="middlename">Middle Name</label>
                <input value="{{$student->middlename}}" disabled name="middlename" id="middlename" type="text" class="block w-full px-4 py-2 mt-2 border rounded-md bg-gray-800 text-gray-300 border-gray-600 focus:border-white  ">
            </div>
        </div>
            ...
            <div class="grid-row-2 col-span-10">
                <div class="grid grid-cols-3 gap-6  sm:grid-cols-10">   
                    <div class="col-span-5">
                        ...
                        <input value="{{$student->department}}" disabled name="department" id="department" type="text" class="block w-full px-4 py-2 mt-2 border rounded-md bg-gray-800 text-gray-300 border-gray-600 focus:border-white  ">
                    </div>
                    <div class="col-span-5">
                        <label class="text-gray-200 pl-2" for="gender">Gender</label>
                        <input value="{{$student->gender}}" disabled name="gender" id="gender" type="text" class="block w-full px-4 py-2 mt-2 border rounded-md bg-gray-800 text-gray-300 border-gray-600 focus:border-white  ">
                    </div>
                </div>
                <br>
