...
<div class="max-w-screen-2xl p-6 mx-auto">
    <div class="grid grid-cols-4 gap-1 sm:px-4 sm:pt-4 sm:grid-cols-8 sm:gap-4">
        ...
        <div class="col-span-1 sm:col-span-1">
            <button type="submit" class="block w-full px-2 py-2 sm:mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-white dark:focus:border-white flex items-center justify-center">
