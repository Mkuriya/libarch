...
<div class="sm:mt-6 mt=0 ">
    <section class="max-w-screen-xl p-6 mx-auto rounded-md shadow-md bg-gray-800 ">
        ...
        <form action="/student/dashboard/profile/changepassword/update" method="POST">
            ...
            <div class="mt-4">
                <label class="text-gray-200 pl-2" for="lastname">Old Password</label>
            ...
            <div class="mt-4">
                <label class="text-gray-200 pl-2" for="lastname">New Password</label>
            ...
            <div class="mt-4"> 
                <label class="text-gray-200 pl-2" for="lastname">Confirm Password</label>
                <input  name="confirm_password" id="confirm_password" type="password" class="block w-full px-4 py-2 mt-2  border  rounded-md bg-gray-800 text-gray-300 border-gray-600 focus:border-white ">
            </div>
