...
<div class="sm:mt-6 mt-0 ">
    <section class="max-w-screen-xl p-6 mx-auto rounded-md shadow-md bg-gray-800 ">
        <h1 class="text-xl font-bold text-white capitalize ">Register Student</h1>
        <hr>
        <form action="/admin/dashboard/studentregister" method="POST" enctype="multipart/form-data" >
            ...
            <div class="grid grid-cols-5 gap-6 mt-4 sm:grid-cols-12">
                <div class="sm:col-span-4 col-span-12">
                    ...
                    <input name="studentnumber" value="{{ old('studentnumber') }}" id="studentnumber" maxlength="10" type="number" class="hide-arrows block w-full px-4 py-2 mt-2 border rounded-md bg-gray-800 text-gray-300 border-gray-600 focus:border-white  no-spinner">
                    <span class="text-red-600">@error('email'){{$message}}@enderror</span>
                </div>
                <div class="sm:col-span-4 col-span-12">
                    <label class="text-gray-200" for="email">Email</label>
                    <input name="email" id="email" value="{{ old('email') }}" readonly type="email" placeholder="@dhvsu.edu.ph" class="block w-full px-4 py-2 mt-2 border rounded-md bg-gray-800 text-gray-300 border-gray-600 focus:border-white ">
                    <span class="text-red-600"> @error('email'){{$message}}@enderror</span>
                </div> 
                ...
                <div class="sm:col-span-2 col-span-6">
                    <label class="text-gray-200" for="department">Department</label>
